				...
				<li class="${param.role=='member' ? 'active' : ''} treeview"><a href="<%=basePath%>pages/back/index.jsp"> <i
					...
					<ul class="treeview-menu"> 
						<shiro:hasPermission name="member:add">
							<li class="${param.action=='member:add' ? 'active' : ''}"><a href="<%=basePath%>/WEB-INF/pages/back/healthstandard/healthstandard_addblood.jsp"><i class="fa fa-plus-square"></i>
									增加用户</a></li> 
						</shiro:hasPermission>
						<shiro:hasPermission name="member:list">   
							<li class="${param.action=='member:list' ? 'active' : ''}"><a href="<%=basePath%>/WEB-INF/pages/back/healthstandard/healthstandard_listblood.jsp"><i class="fa fa-list-alt"></i>
									用户列表</a></li>
						</shiro:hasPermission>
					</ul></li>
			</shiro:hasRole>

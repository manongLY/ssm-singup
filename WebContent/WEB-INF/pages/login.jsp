					...
					<div class="panel-body">
						<form action="<%=loginUrl%>" id="myform" method="post" class="form-horizontal">
							<div class="form-group" id="midDiv">
								...
								<div class="col-md-5">
									<input type="text" name="mid" id="mid" value="admin" class="form-control input-sm" placeholder="请输入管理员为您提供的帐号...">
								</div>
							...
							<div class="form-group" id="passwordDiv">
								...
								<div class="col-md-5">
									<input type="password" name="password" id="password" value="hello" class="form-control input-sm" placeholder="请输入登录密码...">
								</div>
